USE [master]
GO
/****** Object:  Database [AccDBF]    Script Date: 2/5/2026 10:33:38 PM ******/
...
USE [AccDBF]
GO
/****** Object:  Table [dbo].[tblAlerts]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tblDepartments]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblPackages]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProcess]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProcessDepartment]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProject]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblSupplier]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[tblSupplier](
	...
	[supplierType] [nvarchar](100) NOT NULL,
...
GO
/****** Object:  Table [dbo].[tblSupplierNames]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[tblSupplierNames](
	[supplierNameID] [int] IDENTITY(1,1) NOT NULL,
	[supplierName] [nvarchar](200) NOT NULL,
PRIMARY KEY CLUSTERED 
(
	[supplierNameID] ASC
...
GO
/****** Object:  Table [dbo].[tblTasks]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblUsers]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblWorkflowDtl]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblWorkflowHdr]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblWorkflowSteps]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblWorkflowTaskHistory]    Script Date: 2/5/2026 10:33:38 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[tblWorkflowTaskHistory](
	[TaskHistoryID] [int] IDENTITY(1,1) NOT NULL,
	[workFlowID] [int] NOT NULL,
	[PaymentStep] [int] NOT NULL,
	[TaskID] [int] NOT NULL,
...
GO
ALTER TABLE [dbo].[tblDepartments] ADD  DEFAULT ((0)) FOR [MovePassOnce]
GO
ALTER TABLE [dbo].[tblProcessDepartment] ADD  DEFAULT ((0)) FOR [IsActive]
GO
ALTER TABLE [dbo].[tblSupplier] ADD  DEFAULT (sysdatetime()) FOR [createdDate]
GO
ALTER TABLE [dbo].[tblTasks] ADD  DEFAULT ((0)) FOR [isDoneOnce]
GO
ALTER TABLE [dbo].[tblUsers] ADD  DEFAULT ((0)) FOR [IsSpecialUser]
GO
ALTER TABLE [dbo].[tblWorkflowDtl] ADD  DEFAULT ('Pending') FOR [Status]
GO
ALTER TABLE [dbo].[tblWorkflowDtl] ADD  DEFAULT ((0)) FOR [isDoneOnce]
GO
ALTER TABLE [dbo].[tblWorkflowSteps] ADD  CONSTRAINT [DF_tblWorkflowSteps_isActive]  DEFAULT ((1)) FOR [isActive]
GO
ALTER TABLE [dbo].[tblWorkflowSteps] ADD  CONSTRAINT [DF_tblWorkflowSteps_createdDate]  DEFAULT (sysdatetime()) FOR [createdDate]
GO
ALTER TABLE [dbo].[tblWorkflowTaskHistory] ADD  DEFAULT (getdate()) FOR [CompletionDate]
GO
...
GO
ALTER TABLE [dbo].[tblSupplier]  WITH CHECK ADD  CONSTRAINT [FK_tblSupplier_tblWorkflowHdr] FOREIGN KEY([workFlowID])
REFERENCES [dbo].[tblWorkflowHdr] ([workFlowID])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[tblSupplier] CHECK CONSTRAINT [FK_tblSupplier_tblWorkflowHdr]
GO
...
GO
ALTER TABLE [dbo].[tblWorkflowSteps]  WITH CHECK ADD  CONSTRAINT [FK_tblWorkflowSteps_tblSupplier] FOREIGN KEY([supplierID])
REFERENCES [dbo].[tblSupplier] ([supplierID])
GO
ALTER TABLE [dbo].[tblWorkflowSteps] CHECK CONSTRAINT [FK_tblWorkflowSteps_tblSupplier]
GO
ALTER TABLE [dbo].[tblWorkflowSteps]  WITH CHECK ADD  CONSTRAINT [FK_tblWorkflowSteps_tblWorkflowHdr] FOREIGN KEY([workFlowID])
REFERENCES [dbo].[tblWorkflowHdr] ([workFlowID])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[tblWorkflowSteps] CHECK CONSTRAINT [FK_tblWorkflowSteps_tblWorkflowHdr]
GO
ALTER TABLE [dbo].[tblWorkflowTaskHistory]  WITH CHECK ADD FOREIGN KEY([TaskID])
REFERENCES [dbo].[tblTasks] ([TaskID])
GO
ALTER TABLE [dbo].[tblWorkflowTaskHistory]  WITH CHECK ADD FOREIGN KEY([workFlowID])
REFERENCES [dbo].[tblWorkflowHdr] ([workFlowID])
GO
USE [master]
GO
